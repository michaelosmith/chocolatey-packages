...
$packageName= 'bbwin' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://sourceforge.net/projects/bbwin/files/bbwin/0.13/BBWin_0.13.msi/download' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'bbwin*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
# Check if bbwin is installed already
...
#} elseif ($key.Count -eq 1) {
  #Write-Warning "Package $packageName seems to be installed already"
